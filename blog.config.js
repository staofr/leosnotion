const BLOG = {
  ...
  description: 'ça va être un super blog.',
  ...
  lightBackground: '#F0FFFF', // use hex value, don't forget '#' e.g #fffefc
  darkBackground: '#374a40', // use hex value, don't forget '#'
  ...
  socialLink: 'https://blog.leosun.fr',
  seo: {
